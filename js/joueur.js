class Joueur {
  constructor(idJoueur,nom,prenom,armeJoueur,couleurFond,imageJoueur,actif,dCase) {
  ...
  mouvementJoueur(nombreCaseDeplacement) {
    ...
    this.casePossible(this.dCase.posX, 1, -1, "X");

    /*deplacement vers le bas*/
    this.casePossible(this.dCase.posX, 10, +1, "X");

    /*deplacement vers la gauche */
    this.casePossible(this.dCase.posY, 1, -1, "Y");

    /*deplacement vers la droite */
    this.casePossible(this.dCase.posY, 10, +1, "Y");
  }
